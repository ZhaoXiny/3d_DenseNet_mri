...
train_params = {
  ...
  'batch_size': 10,
  'n_epochs': 70,
  'crop_size': (91,91), # The (width, height) of images that we used to trian the model
  'sequence_length': 109,
  ...
  'queue_size': 30, # The data queue size when we extract the data from dataset,should be set according to your memory size
...
if __name__ == '__main__':
  ...
  # write all the log to the file without buffer, add flowing codes can't run, and I don't why
  f = open('log.txt', 'w', 0)
  sys.stdout = f
  sys.stderr = f
